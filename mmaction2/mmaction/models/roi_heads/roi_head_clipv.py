...
class AVARoICLIPVHead(StandardRoIHead):
    ...
    def loss(self, x: Union[Tensor,
        ...
        bbox_results = self.bbox_loss(x, sampling_results, batch_img_metas, key_img=key_img)
        losses.update(bbox_results['loss_bbox'])

        return losses

    def _bbox_forward(self, x: Union[Tensor, List[Tensor]], rois: Tensor,
                      batch_img_metas: List[dict], key_img:Tensor, **kwargs) -> dict:
        ...
        cls_score = self.bbox_head(bbox_feats, key_img, rois, global_feat)
    ...
    def bbox_loss(self, x: Union[Tensor, Tuple[Tensor]],
        ...
        bbox_results = self._bbox_forward(x, rois, batch_img_metas, key_img=key_img)
    ...
    def predict(self, x: Union[Tensor,
        ...
        results_list = self.predict_bbox(
            x, batch_img_metas, rpn_results_list, rcnn_test_cfg=self.test_cfg, key_img=key_img)

        return results_list

    def predict_bbox(self, x: Tuple[Tensor], batch_img_metas: List[dict],
                     rpn_results_list: InstanceList,
                     rcnn_test_cfg: ConfigType, key_img: Tensor) -> InstanceList:
